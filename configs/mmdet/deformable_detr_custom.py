# File: configs/deformable_detr/deformable_detr_custom_ls.py

# Dataset and runtime base (no dataset config used from _base_)
...
# Data augmentation and training pipeline
train_pipeline = [
...
# Evaluators
#val_evaluator = dict(type='CocoEvaluator', ann_file=data_root + 'valid/valid.json', metric='bbox')
#test_evaluator = dict(type='CocoEvaluator', ann_file=data_root + 'test/test.json', metric='bbox')
...
# Work directory for checkpoints and logs
work_dir = './work_dirs/deformable_detr_custom_ls'
