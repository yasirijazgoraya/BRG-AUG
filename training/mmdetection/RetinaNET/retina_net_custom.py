...
# Load pre-trained RetinaNet weights (optional, good for fine-tuning)
#load_from = 'https://download.openmmlab.com/mmdetection/v2.0/retinanet/' \
 #           'retinanet_r50_fpn_1x_coco/retinanet_r50_fpn_1x_coco_20200130-5c8b7ec4.pth'

#load_from = 'https://download.openmmlab.com/mmdetection/v3.0/retinanet/retinanet_r50_fpn_1x_coco/retinanet_r50_fpn_1x_coco_20221129_095917-435d46b9.pth'
